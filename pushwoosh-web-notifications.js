...
/***/ function(module, exports, __webpack_require__) {
	...
	function main() {
	    var global = functions_1.getGlobal();
	    var Pushwoosh = global.Pushwoosh;
	    var predefinedCommands;
	    if (Pushwoosh) {
	        predefinedCommands = Pushwoosh;
	    }
	    Pushwoosh = new Pushwoosh_1.default();
	    if (Array.isArray(predefinedCommands)) {
	        predefinedCommands.forEach(function (c) { return Pushwoosh.push(c); });
	    }
...
/***/ }
/******/ ]);
//# sourceMappingURL=pushwoosh-web-notifications.uncompress.js.map